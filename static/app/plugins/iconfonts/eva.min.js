...
/*! no static exports found */function (t, e, a) {
        ...
        */
        /*!
          ...
          http://jedwatson.github.io/classnames
        */
        !function () { "use strict"; var a = function () { function g() { } function i(a, t) { for (var e = t.length, h = 0; h < e; ++h)r(a, t[h]) } g.prototype = Object.create(null); var h = {}.hasOwnProperty; var d = /\s+/; function r(a, t) { if (t) { var e = typeof t; "string" === e ? function (a, t) { for (var e = t.split(d), h = e.length, r = 0; r < h; ++r)a[e[r]] = !0 }(a, t) : Array.isArray(t) ? i(a, t) : "object" === e ? function (a, t) { for (var e in t) h.call(t, e) && (a[e] = !!t[e]) }(a, t) : "number" === e && (a[t] = !0) } } return function () { for (var a = arguments.length, t = Array(a), e = 0; e < a; e++)t[e] = arguments[e]; var h = new g; i(h, t); var r = []; for (var d in h) h[d] && r.push(d); return r.join(" ") } }(); void 0 !== t && t.exports ? (a.default = a, t.exports = a) : void 0 === (h = function () { return a }.apply(e, [])) || (t.exports = h) }()
...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function (a, t, e) {
        "use strict"; e.r(t); var h = e(/*! ./icon */"./package/src/icon.js"), r = e(/*! ../../package-build/eva-icons.json */"./package-build/eva-icons.json");
/**
 * @license
 * Copyright Akveo. All Rights Reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */t.default = Object.keys(r).map(function (a) { return new h.default(a, r[a]) }).reduce(function (a, t) { return a[t.name] = t, a }, {})
      }, "./package/src/index.js":
/*!******************************!*\
  !*** ./package/src/index.js ***!
  \******************************/
/*! exports provided: icons, replace */function (a, t, e) {
        "use strict"; e.r(t); var h = e(/*! ./icons */"./package/src/icons.js"); e.d(t, "icons", function () { return h.default }); var r = e(/*! ./replace */"./package/src/replace.js"); e.d(t, "replace", function () { return r.default }); var d = e(/*! ./animation.scss */"./package/src/animation.scss");
        /**
         * @license
         * Copyright Akveo. All Rights Reserved.
         * Licensed under the MIT License. See License.txt in the project root for license information.
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: default */function (a, t, e) {
        "use strict"; e.r(t); var h = e(/*! classnames/dedupe */"./node_modules/classnames/dedupe.js"), c = e.n(h), p = e(/*! ./icons */"./package/src/icons.js"); function m(t) { for (var a = 1; a < arguments.length; a++) { var e = null != arguments[a] ? arguments[a] : {}, h = Object.keys(e); "function" == typeof Object.getOwnPropertySymbols && (h = h.concat(Object.getOwnPropertySymbols(e).filter(function (a) { return Object.getOwnPropertyDescriptor(e, a).enumerable }))), h.forEach(function (a) { y(t, a, e[a]) }) } return t } function y(a, t, e) { return t in a ? Object.defineProperty(a, t, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : a[t] = e, a } function z(a, t) {
          if (null == a) return {}; var e, h, r = function (a, t) { if (null == a) return {}; var e, h, r = {}, d = Object.keys(a); for (h = 0; h < d.length; h++)e = d[h], 0 <= t.indexOf(e) || (r[e] = a[e]); return r }
/**
 * @license
 * Copyright Akveo. All Rights Reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
 */(a, t); if (Object.getOwnPropertySymbols) { var d = Object.getOwnPropertySymbols(a); for (h = 0; h < d.length; h++)e = d[h], 0 <= t.indexOf(e) || Object.prototype.propertyIsEnumerable.call(a, e) && (r[e] = a[e]) } return r
